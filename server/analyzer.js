...
const analyzeCodeWithAI = async (code) => {
    ...
    3. Generate a 3-4 step "Interview Breakdown" explaining the logic, time complexity reasoning, and space complexity reasoning to help a student prepare for a software engineering interview.
